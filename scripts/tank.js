    ...
    return {
        ...
        reset : function () {
            ...
            for (var key in upgrades) {
                ...
                box += '<div id="' + upgrades[key].stat + '" class="upgrade-box flip-vertical" style="display: inline-block; position: relative; width: 48px; padding-top: 32px; text-align: center; background: url(' + upgrades[key].image + ') top center no-repeat; cursor: pointer;" onclick="$(this).find($(\'strong\')).html(TANK.upgrade.buy(\'' + key + '\'));" onmouseover="$(this).children(\'.upgrade-hover-box\').show()" onmouseout="$(this).children(\'.upgrade-hover-box\').hide()">\
